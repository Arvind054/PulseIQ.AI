...
export const metadata: Metadata = {
  title: "PulseIQ.AI — AI-Powered Observability",
  description:
    "Monitor system logs and use AI to find root causes of errors. Trace cascade failures and see what broke first across your services.",
};
